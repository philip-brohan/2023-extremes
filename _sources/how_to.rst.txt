...
This project is designed to be easy to reproduce and extend. Everything involved is kept under version control in a `git repository <https://en.wikipedia.org/wiki/Git>`_. The repository is hosted on `GitHub <https://github.com/>`_ (and the documentation made with `GitHub Pages <https://pages.github.com/>`_). The repository is `<https://github.com/philip-brohan/2023-extremes>`_; it contains everything you need to reproduce or extend this work.

If you are familiar with GitHub, you already know what to do (fork or clone `the repository <https://github.com/philip-brohan/2023-extremes>`_): If you'd prefer not to bother with that, you can download the whole thing as `a zip file <https://github.com/philip-brohan/2023-extremes/archive/master.zip>`_.
...
.. literalinclude:: ../environment/Ex-2023.yml
...
The project documentation (these web pages) are included in the repository (in the `docs directory <https://github.com/philip-brohan/2023-extremes/tree/main/docs>`_). The documentation is in `reStructuredText <https://en.wikipedia.org/wiki/ReStructuredText>`_ format, and uses the `Sphinx <https://docs.readthedocs.io/en/stable/intro/getting-started-with-sphinx.html>`_ documentation generator.
