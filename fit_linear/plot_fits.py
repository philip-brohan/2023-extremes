...
# Plot maps of the three parameters in the linear fit
# For a specified month - intercept, slope, and residual variance.
...
slope = iris.load_cube(
    "%s/Ex-2023/fit_linear/slope_m%02d.nc" % (os.getenv("SCRATCH"), args.month),
)
intercept = iris.load_cube(
    "%s/Ex-2023/fit_linear/intercept_m%02d.nc" % (os.getenv("SCRATCH"), args.month),
)
variance = iris.load_cube(
    "%s/Ex-2023/fit_linear/variance_m%02d.nc" % (os.getenv("SCRATCH"), args.month),
)
